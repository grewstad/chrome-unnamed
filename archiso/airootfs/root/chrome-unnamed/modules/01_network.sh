...
# Forces networking on, unblocks radio, and triggers an explicit rescan.
gum spin --title "Waking up network hardware..." -- bash -c "rfkill unblock all && nmcli networking on && nmcli dev wifi rescan && sleep 2"
